            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('short_description') is-invalid @enderror"
                              id="short_description" name="short_description" rows="3">{{ old('short_description', $project->short_description) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    @if($project->featured_image)
                        <div class="mt-2">
                            <img src="{{ Storage::url($project->featured_image) }}" alt="Featured Image" style="max-width: 200px;">
                        </div>
                    @endif
                </div>
                    ...
                    @if($project->gallery_images)
                        <div class="mt-2 d-flex flex-wrap">
                            @foreach($project->gallery_images as $image)
                                <img src="{{ Storage::url($image) }}" alt="Gallery Image" style="max-width: 100px; margin-right: 10px; margin-bottom: 10px;">
                            @endforeach
                        </div>
                    @endif
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('technologies') is-invalid @enderror"
                           id="technologies" name="technologies" value="{{ old('technologies', implode(',', $project->technologies ?? [])) }}">
                    @error('technologies')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('sort_order') is-invalid @enderror"
                                   id="sort_order" name="sort_order" value="{{ old('sort_order', $project->sort_order) }}">
                            @error('sort_order')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="form-group">
                    <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input" id="is_published"
                               name="is_published" value="1" {{ old('is_published', $project->is_published) ? 'checked' : '' }}>
